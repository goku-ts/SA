            ...
            <Modal visible={visible} transparent={true}>
                <View style={{
                    ...
                    <View style={{
                        ...
                        width: desktop ? 550 : ImageSize ? ImageSize : width * 0.85,
                        height: desktop ? 900 : height * 0.84,
                    }}>
                        <View style={{
                        ...
                        <View style={{
                            ...
                            <Image source={image} style={{
                                resizeMode: "cover",
                                width: desktop ? 500 : ImageSize ? ImageSize : width * 0.8,
                                height: desktop ? 800 : height * 0.7,
                                borderRadius: 3,
                                marginTop: 5
                            }} />
                        </View>
