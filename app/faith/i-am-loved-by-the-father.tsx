            ...
            <View style={[styles.container, {
                ...
                <View style={styles.postContainer}>
                    ...
                    <View style={{
                        ...
                        {
                            backgroundColor:
                                FAITH[post - 1]?.author === "Faith Confession" ? COLORS.orange1
                                    : FAITH[post - 1]?.author === "Declaration" ? COLORS.teal1
                                        : COLORS.orange1
                        }
                        ]}>
                            <Text
                                style={{
                                    ...
                                    fontSize: 14,
                                    color:
                                        FAITH[post - 1]?.author === "Faith Confession" ? COLORS.orange5
                                            : FAITH[post - 1]?.author === "Declaration" ? COLORS.teal9
                                                : COLORS.orange5,
                                }}
                            >
                                {FAITH[post - 1]?.author}
                ...
                <ShareButton url={"https://spiritarmy.com/faith/breaking-out-of-the-mould?id=1"} />
                <View style={{
                    height: 100
                }} />
            </View>
